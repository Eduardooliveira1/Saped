...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {label: 'Cadastrar Cobrança', routerLink: ['/cadastrar-cobranca']},
            {
                label: 'Relatórios', items: [
                    {label: 'Pagamentos', routerLink: ['/relatorios/pagamentos']},
...
@Component({
    ...
    template: `
        <ng-template ngFor let-child let-i="index" [ngForOf]="(root ? item : item.items)">
            <li [ngClass]="{'active-menuitem': isActive(i),'active-menuitem-submenu': isActive(i) && child.items && child.items.length>0}" [class]="child.badgeStyleClass"
        ...
        <a class="notificacoes" href="#"><i class="topbar-icon material-icons">notifications</i></a>
    `,
    animations: [
        trigger('children', [
