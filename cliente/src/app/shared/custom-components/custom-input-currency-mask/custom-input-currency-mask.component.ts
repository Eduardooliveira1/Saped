...
@Component({
  selector: 'app-custom-input-currency-mask',
  templateUrl: './custom-input-currency-mask.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CustomInputCurrencyMaskComponent),
      multi: true
    }
  ]

})
export class CustomInputCurrencyMaskComponent implements OnInit, ControlValueAccessor {
